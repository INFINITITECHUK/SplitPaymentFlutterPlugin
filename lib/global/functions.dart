...
abstract class Functions {
  ...
  Future<dynamic> initiateSplitPayment({required double amount, required int splitNumber, required String invoiceId});

  Future<dynamic> submitCustomSplitPaymentInfo({required List<SplitPaymentCustomerDetailsModel> splitCustomerDetails});

  Future<dynamic> updateCustomSplitPaymentInfo({required int customerId, required SplitPaymentCustomerDetailsModel splitCustomerDetails});
